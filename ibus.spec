...
Version  : 1.5.29
Release  : 52
URL      : https://github.com/ibus/ibus/releases/download/1.5.29/ibus-1.5.29-rc2.tar.gz
Source0  : https://github.com/ibus/ibus/releases/download/1.5.29/ibus-1.5.29-rc2.tar.gz
...
Requires: ibus-services = %{version}-%{release}
Requires: UCD
...
%package services
Summary: services components for the ibus package.
Group: Systemd services
Requires: systemd

%description services
services components for the ibus package.


%prep
%setup -q -n ibus-1.5.29-rc2
cd %{_builddir}/ibus-1.5.29-rc2
pushd ..
cp -a ibus-1.5.29-rc2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700238047
unset LD_AS_NEEDED
...
cp %{_builddir}/ibus-%{version}-rc2/COPYING %{buildroot}/usr/share/package-licenses/ibus/caeb68c46fa36651acf592771d09de7937926bb3 || :
cp %{_builddir}/ibus-%{version}-rc2/COPYING.unicode %{buildroot}/usr/share/package-licenses/ibus/8f3995295bed2abde3107e544c985096cb9c745a || :
pushd ../buildavx2/
%make_install_v3
popd
%make_install
...
/usr/share/defaults/xdg/Xwayland-session.d/10-ibus-x11
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/gtk-2.0/2.10.0/immodules/im-ibus.so
/V3/usr/lib64/gtk-3.0/3.0.0/immodules/im-ibus.so
/V3/usr/lib64/gtk-4.0/4.0.0/immodules/libim-ibus.so
/V3/usr/lib64/libibus-1.0.so.5.0.529
...
/usr/lib64/libibus-1.0.so.5.0.529

%files libexec
%defattr(-,root,root,-)
/V3/usr/libexec/ibus-dconf
/V3/usr/libexec/ibus-engine-simple
/V3/usr/libexec/ibus-portal
/V3/usr/libexec/ibus-ui-gtk3
/V3/usr/libexec/ibus-wayland
/V3/usr/libexec/ibus-x11
...
/usr/share/man/man5/00-upstream-settings.5
/usr/share/man/man5/ibus.5
