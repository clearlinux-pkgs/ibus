...
Version  : 1.5.31
Release  : 56
URL      : https://github.com/ibus/ibus/releases/download/1.5.31/ibus-1.5.31.tar.gz
Source0  : https://github.com/ibus/ibus/releases/download/1.5.31/ibus-1.5.31.tar.gz
...
%prep
%setup -q -n ibus-1.5.31
cd %{_builddir}/ibus-1.5.31
pushd ..
cp -a ibus-1.5.31 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731082009
unset LD_AS_NEEDED
...
/V3/usr/lib64/libibus-1.0.so.5.0.531
...
/usr/lib64/libibus-1.0.so.5.0.531
