...
%prep
%setup -q -n ibus-1.5.30
cd %{_builddir}/ibus-1.5.30
pushd ..
cp -a ibus-1.5.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714657209
unset LD_AS_NEEDED
...
/V3/usr/lib64/libibus-1.0.so.5.0.530
...
/usr/lib64/libibus-1.0.so.5.0.530
