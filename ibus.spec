...
Source0  : https://github.com/ibus/ibus/releases/download/1.5.32/ibus-1.5.32.tar.gz
...
%prep
%setup -q -n ibus-1.5.32
cd %{_builddir}/ibus-1.5.32
pushd ..
cp -a ibus-1.5.32 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744161004
unset LD_AS_NEEDED
...
/V3/usr/lib64/libibus-1.0.so.5.0.532
...
/usr/lib64/libibus-1.0.so.5.0.532
