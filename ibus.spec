...
%prep
%setup -q -n ibus-1.5.22
cd %{_builddir}/ibus-1.5.22
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582936828
unset LD_AS_NEEDED
...
cp %{_builddir}/ibus-1.5.22/COPYING %{buildroot}/usr/share/package-licenses/ibus/caeb68c46fa36651acf592771d09de7937926bb3
cp %{_builddir}/ibus-1.5.22/COPYING.unicode %{buildroot}/usr/share/package-licenses/ibus/8f3995295bed2abde3107e544c985096cb9c745a
%make_install
%find_lang ibus10
...
/usr/lib64/libibus-1.0.so.5.0.522
